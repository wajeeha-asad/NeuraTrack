...
export default function CreatePathDialog({
  open,
  onOpenChange,
  onCreate,
}) {
      ...
      <DialogContent className="max-h-[90vh] w-[calc(100%-1rem)] max-w-lg overflow-y-auto border-white/10 bg-[#101633] text-white sm:w-full">
        ...
        <DialogHeader>
          ...
          <DialogDescription className="text-slate-400">
            Create a personalized path and start tracking your progress.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <select
                {...register("category")}
                className="h-10 w-full rounded-md border border-white/10 bg-[#151B45] px-3 text-sm text-white outline-none focus:ring-2 focus:ring-[#8B5CF6]"
              >
                <option value="">
                  Select category
                </option>
